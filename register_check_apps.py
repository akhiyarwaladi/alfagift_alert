...
class RegisterCheck:
    ...
    def score_user_otp(self, ip_adress, device_id, phone_num, device_model):
        ...
        if sum_score >= 0.6:
            is_fraud = True
            if score_pair1 > 0:
                li_reason.append('Pasangan IP dan Device ID kamu telah digunakan')
            if score_pair2 > 0:
                li_reason.append('Pasangan IP dan Device Model kamu telah digunakan')
            if score_pair3 > 0:
                li_reason.append('Pasangan Phone and Device ID kamu telah digunakan')
